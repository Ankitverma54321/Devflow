...
const Question = ({ mongoUserId }: Props) => {
  ...
  //   1. Define your form.
  const form = useForm<z.infer<typeof QustionsSchema>>({
    resolver: zodResolver(QustionsSchema),
    defaultValues: {
      title: "",
      explanation: "",
      tags: [],
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormDescription className="body-regular mt-2.5 text-light-500">
                Be specific and imagine you&spos;re asking a question to another
                person.
              </FormDescription>
                  ...
                  {field.value.length > 0 && (
                    <div className="flex-start mt-2.5 gap-2.5">
                      {field.value.map((tag: any) => (
                        ...
                        rounded-md border-none px-4 py2 capitalize"
